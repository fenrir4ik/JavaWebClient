 ...
 * 
 */
@WebServiceClient(name = "OrdersService", targetNamespace = "http://services/", wsdlLocation = "http://localhost:8000/orders?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8000/orders?wsdl");
